<?php
    ...
    /** 
      ...
      DO NOT EDIT THIS OR THE THEME WILL NOT WORK
      578234766
      2854
      3928957287
           !!! Blackspigot.com on top !!!

    **/

    
class Rogue_Template extends TemplateBase {
    ...
    public function __construct($cache, $smarty, $language, $user, $pages) {
        $template = [
            ...
            'version' => '2.0.9',
            'nl_version' => '2.1.1',
            'author' => '<a href="https://RavenstoneLLC.net" target="_blank">Ravenstone</a>',
        ];
...
$template = new Rogue_Template($cache, $smarty, $language, $user, $pages);
